...
Azóta is az ő módszere, és annak átalakított változatai az egyetlen minden csoportra alkalmazható ismert algoritmus.
...
Egy tetszőlegesen megadott bázisból Gauss-eliminációval, majd az üres sorok törlésével sor-redukált bázist kaphatunk.
...
\begin{lemma}
\label{thm:bdsmjfix}
Legyen $b_1,b_2,\dots,b_s$ a $V$ karakteraltér sor-redukált bázisa.
