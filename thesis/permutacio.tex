...
Lehet az is, hogy a végén $g_{m+1} \neq 1$.
...
\begin{lemma}
\label{thm:sims2}
Legyen $\{\beta_1, \beta_2, \dots, \beta_k\} \subseteq \Omega$ és $G \le \Sym(\Omega)$. $1 \le i \le k+1$-re legyen $S_i \subseteq G^{[i]} = G_{(\beta_1, \beta_2, \dots, \beta_{i-1})}$,
