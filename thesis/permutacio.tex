...
\todo{bizonyitás lehet hogy kellene futásidőkhöz}
\todo{bázisváltás}
...
Sajnos egy kettős mellékosztály első elemét megtalálni NP-nehéz probléma (\cite{Luk93}), ezért kicsit másképp kell csinálnunk.
\begin{lemma}
